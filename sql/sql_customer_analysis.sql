...
--  Q2.Which customers used a difscount but still spent more than the avgerage purchase amount?
...
-- Q3.What are the top 5 product with the heighest average review rating?
...
-- on their total number of pervious purchase, and show the count of each segment?
